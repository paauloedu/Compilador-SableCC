...
public final class AArAtribuicaoAAtrib extends PAAtrib
{
    private PAExp _esq_;
    private PAExp _dir_;

    public AArAtribuicaoAAtrib()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArAtribuicaoAAtrib(
    ...
    {
        ((Analysis) sw).caseAArAtribuicaoAAtrib(this);
    }
