...
public interface Analysis extends Switch
{
    ...
    void caseAStatementComando(AStatementComando node);
    void caseADirectStatementComando(ADirectStatementComando node);
    void caseASeStatement(ASeStatement node);
    void caseASeAbertoStatement(ASeAbertoStatement node);
    void caseASeSenaoStatement(ASeSenaoStatement node);
    void caseAEnquantoStatement(AEnquantoStatement node);
    void caseAArrodeieStatement(AArrodeieStatement node);
    void caseADirectStatement(ADirectStatement node);
    void caseASeSenaoDirectDirectStatement(ASeSenaoDirectDirectStatement node);
    void caseAEnquantoDirectDirectStatement(AEnquantoDirectDirectStatement node);
    void caseAArrodeieDirectDirectStatement(AArrodeieDirectDirectStatement node);
    void caseAMandeDeVoltaBasicStatement(AMandeDeVoltaBasicStatement node);
    void caseAAtribuicaoBasicStatement(AAtribuicaoBasicStatement node);
    void caseABlocoBasicStatement(ABlocoBasicStatement node);
    void caseAChamadaBasicStatement(AChamadaBasicStatement node);
